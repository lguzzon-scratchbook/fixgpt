...
const argv = yargs(hideBin(process.argv))
	...
	.command(
		...
		async argv => {
			...
			const argumentsRegexp = /\[\[args\.([A-z\d-_]+)\.([A-z\d-_]+)]]/g;
			const arguments_ = [...template.matchAll(argumentsRegexp)];
			const alreadyAsked = [];
			for (const match of arguments_) {
